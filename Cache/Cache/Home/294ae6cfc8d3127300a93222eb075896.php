...
<?php
 $implist = M('Article')->where('catid=7 and posid=1')->limit(3)->order('createtime')->select(); $implist1 = M('Article')->where('catid=7 and posid=12')->limit(2)->order('createtime')->select(); $rightlist1 = M('Article')->where('catid=7 and posid=2')->limit(10)->order('createtime')->select(); $rightlist2 = M('Article')->where('catid=7 and posid=3')->limit(10)->order('createtime')->select(); $rightlist3 = M('Article')->where('catid=7 and posid=4')->limit(10)->order('createtime')->select(); ?>
<div class="contain w1000">
    <div class="articleListTop lvyouTop clearfix">
        <div class="articleListTop_l fl">
            <a class="lvyou-left" href="#"></a>
            <a class="lvyou-right" href="#"></a>
        ...
        <div class="articleListTop_r fr">
            <div class="lvyouTop_rlist hoverBox">
                <ul>
                    <?php if(is_array($implist1)): $i = 0; $__LIST__ = $implist1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo ($r["url"]); ?>" class="block"></a>
                            <div class="lvyouTop_rpic"><img src="<?php echo ($r["thumb"]); ?>" width="280" height="170" alt=""></div>
                            <div class="lvyouTop_rtitle ms300"><?php echo ($r["title"]); ?></div>
    ...
    <div class="articleList clearfix">
        <div class="lvyouList_title"><span>旅游热点</span></div>
            ...
            <div class="articleList_lcon hoverBox">
                <ul id="ajax_list_ul">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li>
                            <div class="lvyouList_lBox">
                                <a href="" class="block"></a>
                                <div class="lvyouList_ltitle ms300"><?php echo ($r["title"]); ?></div>
                                <div class="lvyouList_lpics">
                                    <dl class="clearfix">
                                        <dd><img src="/dist/pc/images/in106.jpg" width="220" height="140" alt=""></dd>
                                        <dd><img src="/dist/pc/images/in107.jpg" width="220" height="140" alt=""></dd>
                                        <dd><img src="/dist/pc/images/in108.jpg" width="220" height="140" alt=""></dd>
                                    </dl>
                                </div>
                                <div class="lvyouList_ltime"><?php echo date('Y-m-d H:i',$r['createtime']) ?></div>
                            </div>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        ...
        <div class="articleList_r fr">
            <div class="articleList_rbox">
                <div class="articleList_rcatname"><a href="">旅游攻略</a></div>
            ...
            <div class="inAD"><a href=""><img src="/Uploads/201802/5a7bec52aef4f.jpg" alt=""></a></div>
            <div class="articleList_rbox">
                <div class="articleList_rcatname"><a href="">休闲美食</a></div>
                <div class="articleList_ritem hoverBox">
                    <ul>
            ...
            <div class="articleList_rbox">
                <div class="articleList_rcatname"><a href="">特别策划</a></div>
                <div class="articleList_ritem hoverBox">
                    <ul>
...
<script>
    ...
    $('.lvyou-left').on('click', function(e){
        e.preventDefault()
        shishangSwiper.swipePrev()
    })
    $('.lvyou-right').on('click', function(e){
        e.preventDefault()
