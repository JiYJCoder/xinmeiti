        ...
        <thead>
      	...
      	<tbody>
			...
			<td><?php echo ($vo['pos']); ?></td>
      		<td align="center">
			<a href="<?php echo U($module_name.'/edit',array(id=>$vo['id'],pos=>$vo['pos']));?>"><?php echo L('edit');?></a> |
			<a href="javascript:confirm_delete('<?php echo U($module_name.'/delete',array(id=>$vo['id']));?>')"><?php echo L('delete');?></a>
      		</td>
