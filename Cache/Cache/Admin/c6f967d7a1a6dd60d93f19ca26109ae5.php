...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
			...
			<th  width="60" align="left"><?php echo L(width);?></th>
			<th  width="60" align="left"><?php echo L(height);?></th>
			<th  width="60" align="center"><?php echo L(STATUS);?></th>
			<th width="200"   align="center"><?php echo L('manage');?></th>
      		</tr>
      	</thead>
      	<tbody>
			...
			<td align="center"><?php if(($vo['status']) == "1"): echo L('enable');?>
      		<?php else: ?>
      		<?php echo L('disable'); endif; ?></td>
			<td align="center">
			<a href="<?php echo U('Slide/picmanage',array(fid=>$vo['id']));?>"><?php echo L('PICMANAGE');?></a> | 
			<a href="<?php echo U('Slide/addpic?fid='.$vo[id]);?>"  class="ui-btn"><?php echo L(add_pic);?></a> |
			<a href="<?php echo U('Slide/edit',array(id=>$vo['id']));?>"><?php echo L('edit');?></a> | <a href="javascript:confirm_delete('<?php echo U('Slide/delete',array(id=>$vo['id']));?>')"><?php echo L('delete');?></a></td>
