...
//
//			$str = '<script id="editor_'.$info['field'].'" name="'.$info['field'].'" type="text/plain">'.$value.'</script>
//					<script type="text/javascript">UE.getEditor("editor_'.$info['field'].'",{initialFrameWidth:1000,initialFrameHeight:300});</script>';
//		}
