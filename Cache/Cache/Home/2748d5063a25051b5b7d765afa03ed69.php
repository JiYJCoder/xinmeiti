...
<?php
 $implist = M('Article')->where('catid=10 and posid=1')->limit(4)->order('createtime')->select(); $implist1 = M('Article')->where('catid=10 and posid=14')->limit(10)->order('createtime')->select(); $rightlist1 = M('Article')->where('catid=10 and posid=2')->limit(10)->order('createtime')->select(); $rightlist2 = M('Article')->where('catid=10 and posid=3')->limit(10)->order('createtime')->select(); $rightlist3 = M('Article')->where('catid=10 and posid=4')->limit(10)->order('createtime')->select(); ?>
    ...
    <div class="articleListTop clearfix">
        ...
        <div class="articleListTop_r fr">
            <div class="yuqingTop_ritem">
                <div class="yuqingTop_rcatname"><a href="">舆情播报</a></div>
    ...
    <div class="articleList clearfix">
        ...
        <div class="articleList_r fr">
            <div class="articleList_rbox">
                <div class="articleList_rcatname"><a href="">热点聚焦</a></div>
            ...
            <div class="inAD"><a href=""><img src="/Uploads/201802/5a7bec86bf8ef.jpg" alt=""></a></div>
            <div class="articleList_rbox">
            ...
            <div class="articleList_rbox">
                <div class="articleList_rcatname"><a href="">地方舆情</a></div>
                <div class="articleList_ritem hoverBox">
                    <ul>
